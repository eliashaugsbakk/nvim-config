...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      -- Merge custom servers from lua/custom/lsp.lua
      local has_custom_lsp, custom_lsp = pcall(require, 'custom.lsp')
      if has_custom_lsp then servers = vim.tbl_deep_extend('force', servers, custom_lsp) end
